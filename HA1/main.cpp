...
while (active==0){
    ...
    //Display menu-options
     ...
     case 'C':
     case 'c':
        cout << "You want to convert your XML-productlist and your TXT-productlist into one XML-file." << endl;
        cout << "Please enter the name of your TXT-file (e.g. products.txt)" << endl;
        cin >> txtfilename;
